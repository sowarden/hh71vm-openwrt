...
/* __maybe_unused: the only consumer is vlan_single_open(), which is disabled in this
   configuration. Keep the currently unused function because it becomes useful when
   the diagnostic files in /proc are enabled. */
