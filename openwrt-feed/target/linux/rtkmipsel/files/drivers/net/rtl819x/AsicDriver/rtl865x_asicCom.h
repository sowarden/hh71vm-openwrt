...
/*
 * Missing declarations from the vendor header: both functions are defined in
 * rtl865x_asicCom.c (lines 845 and 863) under the same `#if defined(CONFIG_RTL_8197F)`,
 * but are not declared anywhere, and rtl865x_proc_debug/rtl_nic calls them. Under GCC 4.4 it is
 * was a warning, under our GCC 7.5 with -Werror - an error.
 */
#if defined(CONFIG_RTL_8197F)
