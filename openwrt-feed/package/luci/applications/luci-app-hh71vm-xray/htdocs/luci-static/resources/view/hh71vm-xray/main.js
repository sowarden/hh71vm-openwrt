...
var CSS = [
	...
	'#modal_overlay>.modal.xray-profile-modal{height:calc(100vh - 96px);',
	'  max-width:1040px;overflow:hidden;',
	'  grid-template-rows:auto minmax(0,1fr) auto}',
	'.xray-settings-modal>.xray-form,.xray-profile-modal>.xray-form{',
	'  height:100%;max-height:100%;min-height:0;align-self:stretch;',
	'  box-sizing:border-box;overflow-y:auto;padding-right:.7rem;',
	...
	'    padding:16px}',
	'  #modal_overlay>.modal.xray-settings-modal,',
	'  #modal_overlay>.modal.xray-profile-modal{height:calc(100vh - 32px)}',
