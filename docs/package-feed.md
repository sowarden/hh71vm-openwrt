...
The historical images in `firmware/` predate this feed. They cannot acquire the
new feed automatically without a firmware update. Their existing manual bundle
recipe remains under [`extras/`](../extras/).
